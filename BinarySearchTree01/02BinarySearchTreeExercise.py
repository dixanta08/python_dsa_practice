...
if __name__ == "__main__":
    root = build_tree([15,12,7,14,27,20,20,23,88])
    ...
    print(f"Searching 7: {root.search(7)}")
    print(f"Min: {root.find_min()}")
    print(f"Max: {root.find_max()}")
    print(f"Sum: {root.calculate_sum()}")